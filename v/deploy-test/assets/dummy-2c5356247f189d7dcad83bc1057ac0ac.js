...
define("dummy/templates/application", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "m1hgacTK", "block": "{\"symbols\":[],\"statements\":[[6,\"h2\"],[9,\"id\",\"title\"],[7],[0,\"Welcome to an app that actually deploys all the way\"],[8],[0,\"\\n\\n\"],[1,[18,\"outlet\"],false],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "dummy/templates/application.hbs" } });
});
